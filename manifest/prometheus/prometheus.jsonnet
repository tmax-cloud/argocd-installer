			...
			"containers": [
			  {
				"args": [
				  ...
				  "--logtostderr=true",
				  std.join("--config-reloader-image=quay.io/coreos/configmap-reload:",configmap_reload_version),
				  std.join("--prometheus-config-reloader=quay.io/coreos/prometheus-config-reloader:",configmap_reloader_version)
				],
