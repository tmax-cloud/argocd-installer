...
},
{
  ...
  "data": {
    ...
    "clusterDomain": "cluster.local",
    "containerRuntimeExecutor": "pns",
    "executorImage": std.join("", [argo_image_repo, "/argoexec:", argo_image_tag]),
    "namespace": ""
  },
  "kind": "ConfigMap",
  "metadata": {
        ...
        "containers": [
          {
            ...
            "image": std.join("", [argo_image_repo, "/argocli:", argo_image_tag]),
            "name": "argo-server",
            "ports": [
              {
                "containerPort": 2746,
        ...
        "containers": [
          {
            ...
            "image": std.join("", [argo_image_repo, "/workflow-controller:", argo_image_tag]),
            "livenessProbe": {
              "httpGet": {
                "path": "/metrics",
                "port": "metrics"
