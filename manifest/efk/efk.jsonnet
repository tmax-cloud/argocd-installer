...
local resource_uri = if is_master_cluster == "true" then "" else "/console/kibana";
local single_kibana_cmdata = if is_master_cluster == "true" then "" else std.join("", 
  [
          ...
          "containers": [
          ...
          ] + if gatekeeper_enabled then [
            {
              ...
              "args": [
                ...
                "--verbose"
              ] + if is_master_cluster == "false" then [
